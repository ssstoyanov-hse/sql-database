...
- Возможные изменения:
 	1 - добавить нового покупателя или список таковых с последующим расширением таблицы покупок
 	2 - удалить некооторое кол-во значений из таблицы покупок
 	3 - уменьшить список книг в магазинах “Наука” или “Знание”
...
- Возможные изменения:
 	1 - добавить новый магазин с наивысшим значением комиссионных
 	2 - добавить нового покуавтеля с расширением списка покупок
 	2 - увеличить кол-во значений в таблице покупок
 	3 - уменьшить список книг в магазине с максимальным значением комиссионных
