# Лабораторная работа по курсу БД ![Deadline](https://img.shields.io/date/1618444799) ![Progress](https://progress-bar.dev/65/)
...
where exists(
        ...
        from ПОКУПКА purchase, МАГАЗИН store
