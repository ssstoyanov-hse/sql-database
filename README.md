# Лабораторная работа по БД ![Deadline date](https://img.shields.io/date/1618444799)
...
2. Ввести в ранее созданные таблицы конкретные данные. Использовать скрипт-файл из операторов INSERT или
